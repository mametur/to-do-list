...
describe('app: todo application inspired by Mamé Azad', () => {
	...
	describe("set state: reset the app's ._state property", () => {
		// set the initial state for this grouping of tests
		const newState = {
			todos: [{ text: 'bye', completed: false }],
		};
		app.state = newState;
